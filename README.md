here's ponggers2, mainly a tech demo to show off the trig functions, fps display, texture and font conversion, texture and text (with the custom fonts) drawing with shader support.
